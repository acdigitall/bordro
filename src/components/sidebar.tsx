  ...
  const sidebarContent = (
    <aside className="w-64 bg-gradient-to-b from-[#0F172A] via-[#0B132B] to-[#030712] text-slate-300 h-full flex flex-col border-r border-slate-800/80 select-none z-30 font-sans shadow-2xl relative overflow-hidden backdrop-blur-xl">
      ...
      <div className="flex-1 overflow-y-auto px-3 py-4 space-y-6 relative z-10 custom-sidebar-scroll">
        <div>
          <div className="font-mono text-[9.5px] font-bold text-slate-400 uppercase tracking-[0.15em] px-3 mb-2.5 flex items-center justify-between">
                ...
                <div key={item.href} className="group">
                  <div className="flex items-center justify-between">
                    <Link
                      ...
                      className={`relative flex-1 flex items-center justify-between px-3 py-2.5 rounded-xl text-[12.5px] transition-all duration-200 ease-out ${
                        isActive
                      ...
                      <div className="flex items-center gap-2.5">
                        <Icon
                          className={`w-[17px] h-[17px] shrink-0 transition-transform duration-200 group-hover:scale-110 ${
                            isActive ? 'text-sky-400 drop-shadow-[0_0_8px_rgba(56,189,248,0.5)]' : 'text-slate-400 group-hover:text-sky-400'
                          }`}
                        />
                      ...
                      {item.submenu!.map((sub) => {
                        ...
                        return (
                          <Link
                            ...
                            className={`flex items-center gap-2 py-1.5 px-2 rounded-lg text-[11.5px] transition-all duration-150 ${
                              isSubActive
              ...
              {saasNavigation.map((item) => {
                ...
                return (
                  <Link
                    ...
                    href={item.href}
                    onClick={() => onMobileClose && onMobileClose()}
                    className={`flex items-center gap-2.5 px-3 py-2 rounded-xl text-[12px] font-medium border transition-all ${
                      isActive
