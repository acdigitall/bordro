            ...
            <div className="b2b-card p-4 rounded-lg space-y-4 h-fit">
              ...
              <form onSubmit={handleAdd} className="space-y-3 text-xs">
                ...
                <div>
                  ...
                  >
                    <option value="İcra Kesintisi (1/4)">İcra Kesintisi (1/4)</option>
                    <option value="Eksik Gün Kesintisi">Eksik Gün Kesintisi</option>
                    <option value="Disiplin Cezası">Disiplin Cezası</option>
                    <option value="Hasar / Zarar Tazmini">Hasar / Zarar Tazmini</option>
                  </select>
                </div>
                ...
                >
                  <Plus className="w-4 h-4" /> Kesinti Kaydet
                </button>
              </form>
            </div>
